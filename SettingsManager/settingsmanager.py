...
class SettingsManager:
    ...
    def run(self):
        ...
        if result == 1:
            ...
            self.iface.messageBar().pushMessage(u"Installation", u"Paramètres SITNyon importés (version 1.3.3), redémarrer QGIS pour terminer l'installation.", level = QgsMessageBar.INFO)
